...
import { Ruler } from "lucide-react"; // Changed icon
...
const units = [
  ...
  { name: "Decimeters", symbol: "dm" },
  { name: "Centimeters", symbol: "cm" },
  { name: "Millimeters", symbol: "mm" },
  { name: "Micrometers", symbol: "µm" },
  { name: "Picometers", symbol: "pm" },
  { name: "Nautical Miles", symbol: "nmi" },
  { name: "Miles", symbol: "mi" },
  { name: "Furlongs", symbol: "fur" },
  { name: "Fathoms", symbol: "ftm" },
  { name: "Yards", symbol: "yd" },
  { name: "Feet", symbol: "ft" },
  { name: "Inches", symbol: "in" },
  { name: "Gongli", symbol: "gongli" },
  { name: "Li", symbol: "li" },
  { name: "Zhang", symbol: "zhang" },
  { name: "Chi", symbol: "chi" },
  { name: "Cun", symbol: "cun" },
  { name: "Fen", symbol: "fen" },
  { name: "Li (小李)", symbol: "lii" },
  { name: "Hao", symbol: "hao" },
  { name: "Parsecs", symbol: "pc" },
  { name: "Lunar Distance", symbol: "LD" },
  { name: "Astronomical Units", symbol: "AU" },
  { name: "Light Years", symbol: "ly" }
];
...
export function LengthCalculator() {  // Changed component name
  ...
  useEffect(() => {
    ...
    if (!isNaN(numericValue)) {
      const result = convertLength(numericValue, fromUnit, toUnit);
