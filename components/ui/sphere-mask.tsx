...
export function SphereMask({ reverse = false }: { reverse?: boolean }) {
   return (
      <div
         className={cn(
            // color
            '[--color:rgb(128,128,128)] blur-4xl',
            ...
            // before
            'pt-10 before:absolute before:inset-0 before:size-full before:opacity-40 before:[background-image:radial-gradient(circle_at_bottom_center,var(--color),transparent_70%)]',
